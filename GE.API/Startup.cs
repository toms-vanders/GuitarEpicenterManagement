...
namespace GE.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Personal Services
            services.AddTransient<IInventoryDataAccess, InventoryDataAccess>();
            services.AddTransient<IProductDataAccess, ProductDataAccess>();
            services.AddTransient<ISaleDataAccess, SaleDataAccess>();
            ...
            services.AddSwaggerGen(setup =>
            {
                setup.SwaggerDoc(
                    ...
                    new OpenApiInfo
                    {
                        Title = "Guitar Epicenter Manager API",
                        Version = "v1"
                    });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(x =>
            {
                x.SwaggerEndpoint("/swagger/v1/swagger.json", "GE API v1");
            });
